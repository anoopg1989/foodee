		...
		<footer>
			<p class="pull-left">&copy; <a href="" target="_blank">foodee</a> <?php echo date('Y') ?></p>
			<p class="pull-right">Powered by: <a href="http://www.zybotech.in">Zybotech</a></p>
		</footer>
		<?php } ?>
	...
	<!-- custom script for Form val and adding -->
