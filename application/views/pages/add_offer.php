			...
			<div class="row-fluid">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="<?php echo base_url();?>offers/create_offer" method="post" id="offer_form">
							<fieldset>
                              ...
                              <div class="control-group">
								...
								<div class="controls">
								 <input class="input-xlarge" id="precentage" name="precentage" type="number" value="">
								</div>
							  </div>
                              ...
                              <div class="control-group">
								...
								<div class="controls">
								  <input type="text" class="input-xlarge datepicker" id="date_frm" name="f_date" value="06/16/14">
								</div>
							  </div>
                              <div class="control-group">
								<label class="control-label"><dt>Date to :</dt></label>
								<div class="controls">
								  <input type="text" class="input-xlarge datepicker" id="date_to" name="t_date" value="06/16/14">
								</div>
							  </div>
                             
                              <div class="form-actions">
								<button type="submit" class="btn btn-primary" id="btn_add_offer">Add offer</button>
